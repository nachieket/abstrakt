...
from abstrakt.pythonModules.vendors.security.crowdstrike.sensors.falconsensor.FalconSensorSidecar import (
  FalconSensorSidecar)
from abstrakt.pythonModules.vendors.security.crowdstrike.sensors.falconsensor.AWS import AWS


class AWSDaemonsetInstall(AWS, FalconSensorSidecar):
...
class _AWSDaemonsetUpgrade(AWS, FalconSensorSidecar):
  def __init__(self, falcon_client_id: str,
               falcon_client_secret: str,
               logger: CustomLogger,
               registry: str,
