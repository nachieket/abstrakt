...
from abstrakt.pythonModules.vendors.security.crowdstrike.sensors.aws.AWSFalconSensor import AWSFalconSensor
...
"""
  ...
  def get_helm_chart(self, namespaces=None):
    ...
    registry_type, falcon_image_repo, falcon_image_tag, falcon_image_pull_token = self.get_repo_tag_token(
      sensor_type='sidecar', image_tag=self.sensor_image_tag)
