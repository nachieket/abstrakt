...
from abstrakt.pythonModules.vendors.security.crowdstrike.sensors.__azure.AzureFalconSensor import AzureFalconSensor
  ...
  def execute_helm_chart(self):
    try:
      with MultiThreading() as mt:
        mt.run_with_progress_indicator(self.azure_daemonset_falcon_sensor_thread, 1, 300)
...
class AzureDaemonsetKAC(AzureFalconSensor):
  ...
  def deploy_falcon_kac(self):
    ...
    try:
      with MultiThreading() as mt:
        mt.run_with_progress_indicator(self.azure_daemonset_kac_thread, 1, 300)
