...
def eks_managed_node(
  ...
  manager = AWSDaemonsetOperationsManager(config_file=config_file,
...
def eks_fargate(
  ...
  generate_misconfigs: Annotated[bool, typer.Option('--generate-misconfigs',
                                                    ...
                                                    rich_help_panel='CrowdStrike Artificial '
                                                    'Detections Generator')] = False,
  ecr_iam_policy: Annotated[str, typer.Option('--ecr-iam-policy', help='AWS IAM Policy Name',
                                              show_default=True,
                                              rich_help_panel='AWS Options')] = 'CrowdStrikeFalconContainerEcrPull',
  ecr_sensor_iam_role: Annotated[str, typer.Option('--ecr-sensor-iam-role', help='AWS IAM Role Name for Falcon Sensor',
                                                   show_default=True,
                                                   rich_help_panel='AWS Options')] = 'CrowdStrikeFalconContainerIAMRole',
  ecr_kac_iam_role: Annotated[str, typer.Option('--ecr-kac-iam-role', help='AWS IAM Role Name for KAC',
                                                show_default=True,
                                                rich_help_panel='AWS Options')] = 'CrowdStrikeKACIAMRole',
  ecr_iar_iam_role: Annotated[str, typer.Option('--ecr-iar-iam-role', help='AWS IAM Role Name for IAR',
  ...
  manager = AWSSidecarOperationsManager(config_file=config_file,
                                        cluster_name=cluster_name,
                                        region=region,
                                        vpc_name=vpc_name,
                                        ...
                                        ecr_sensor_iam_role=ecr_sensor_iam_role,
                                        ecr_kac_iam_role=ecr_kac_iam_role,
                                        ecr_iar_iam_role=ecr_iar_iam_role)
