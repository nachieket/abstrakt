...
from abstrakt.pythonModules.vendors.security.crowdstrike.sensors.__gcp.gcpDaemonset.GCPFalconSensorDaemonset \
...
class GCPClusterOperationsManager(__ClusterOperationsManager):
